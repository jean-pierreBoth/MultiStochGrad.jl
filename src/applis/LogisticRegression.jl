...
function make_logistic_term_value(observations:: Observations)
    function(position:: Array{Float64,2}, term :: Int64)
        dims = size(position)
        nbclass = dims[2]
        #
...
```
"""
function logistic_term_value_old(observations:: Observations, position:: Array{Float64,2}, term :: Int64)
    #
    dims = size(position)
    nbclass = dims[2]
    #
...
function logistic_term_gradient_old(observations:: Observations, position:: Array{Float64,2}, 
